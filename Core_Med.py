...
def show_prescription_workflow(user):
    ...
    # Check if final diagnosis exists, otherwise show message
    if 'final_diagnosis' in st.session_state and st.session_state.final_diagnosis:
